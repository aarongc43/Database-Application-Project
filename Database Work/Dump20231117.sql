...
INSERT INTO `products` VALUES (1,3,'Gloves',40,10,'Hand covers for stuff'),(2,3,'Shoes',60,5,'Feety wraps'),(3,7,'Math',65,55,'Numbers headache'),(4,1,'Vitamin',30,20,'Supplements'),(8,1,'Lentils',10,10,'More supps'),(9,6,'new product',10,10,'desc'),(10,5,'usb',15,55,'flash drive'),(11,6,'wrench',40,12,'thing'),(12,6,'crimps',25,4,'crimpers'),(13,6,'scanner',88,62,'network scanner'),(14,2,'thingy',1000,2,'stuff'),(15,2,'left sock',212,1,'missing left sock'),(16,4,'haterade',16,555,'mmm so good'),(17,4,'NTSC',4311,1,'dog water'),(18,5,'monitor',89,6,'pretty pictures'),(19,7,'Paradoxes',0,0,'>_<;'),(20,8,'Socratic Method',9,5,'all the questions'),(21,9,'IT',79797,500,'ALL THE THINGS'),(22,10,'help ticket',80,0,'no'),(25,10,'panic',69,1,'fire');
...
-- Dump completed on 2023-11-17 19:46:09
